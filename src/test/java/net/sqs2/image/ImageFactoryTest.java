...
public class ImageFactoryTest extends TestCase {
	public void testCreateImage(){
		try{
			BufferedImage a001 = ImageFactory.createImage(new File("src/test/resources/test0/a001.tif"), 0);
			BufferedImage a002 = ImageFactory.createImage(new File("src/test/resources/test0/a002.tif"), 0);
